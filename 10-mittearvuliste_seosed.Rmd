...
Kui esitatud näide sind ei kõneta, võid teha tabeli ka mõne muu uurimuse põhjal, kus risttabelites sagedusi on raporteeritud. Näiteks
...
Craméri V-d ja teisi seose tugevuse mõõdikuid saad arvutada ka näiteks pakettidega `lsr` või `effectsize`.  
...
Järgmisel korral läheme kahe tunnuse vaheliste seoste hindamise juurest regressioonimudelite juurde, mis võimaldavad ühe tunnuse muutumist kirjeldada enamate tunnuste kaudu. **NB!** Järgmine praktikum alles ülejärgmisel nädalal (31.03)!
