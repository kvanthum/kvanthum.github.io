...
Kui meil on kasutada ainult sagedustabel (st meil pole algandmeid, kus ridades on vaatlused ja tulpades on tunnused, nt `vorm` ja `nimelisus`), siis peame ggploti kasutamiseks sagedustabeli esmalt pikaks `data.frame` tüüpi tabeliks teisendama.  
