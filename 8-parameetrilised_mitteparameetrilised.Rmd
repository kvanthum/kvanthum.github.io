...
**Kas kahe rühma sees on varieerumine sama suur?** Vaikimisi teeb R Welchi t-testi (*Welch Two Sample t-test*), mis eeldab, et kahe grupi hajuvus ei ole võrdne ehk dispersioonid ei ole võrdsed, mis on tihtipeale tõsi. Dispersioon mäletatavasti on standardhälbe ruut, see näitab seda, kui suur on keskmiselt rühmasisene varieerumine.
...
**Kui aga rühmade vahel on võrdne dispersioon**, siis peaks t-testist valima versiooni, mis eeldab võrdset varieerumist
...
"T-test näitas, et rühmad on erinevad: t (`r round(tulemus$parameter, 1)`) = `r round(tulemus$statistic, 3)`; p < 0.001."



Tihtipeale on kombeks p-väärtust näidata kategooriates suurem kui 0.05 (mitteoluline), väiksem kui 0.05, 0.01 või 0.001. Üldiselt üle kolme komakoha ei ole kombeks esitada, nii et kui muidu võiks ka täpset p-väärtust esidada, siis käesoleva testi p-väärtust `r (tulemus$p.value)` ehk 0.0000000007 tuleks ikkagi esitada kui <0.001.
