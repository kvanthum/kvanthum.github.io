...
```{r echo = FALSE}
load("kysimustik_2022.RData")
dat <- read.delim("kysimustik2021_taiend.txt", fileEncoding = "UTF-8")
kyssad <- dat[1,]
```
...
library(webp)
library(png)
glaucus <- read_webp("glaucus.png")
kaelkirjak <- readPNG("giraffe.png")
koer <- read_webp("dog.webp")
...
<p style="text-align: right;">![](q15.PNG){width=40%}</p>
...
<p style="text-align: right;">![](q1.PNG){width=40%} ![](q2.PNG){width=40%}</p>
...
```
<p style="text-align: right;">![](q3.PNG){width=40%}</p>
<p style="text-align: right;">Küsimus R-i testist</p>
...
<p style="text-align: right;">![](q11.PNG){width=60%}</p>
<p style="text-align: right;">Küsimus R-i testist</p>
...
<p style="text-align: right;">![](q5.PNG){width=40%}</p>
<p style="text-align: right;">Küsimus R-i testist</p>
...
<p style="text-align: right;">![](q8.PNG){width=40%} ![](q9.PNG){width=40%}</p>
<p style="text-align: right;">![](q4.PNG){width=40%}</p>
<p style="text-align: right;">Küsimused R-i testist</p>
