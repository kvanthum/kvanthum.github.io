...
<center>![](imgs/levshina.jpg){width=40%} ![](imgs/winter.jpg){width=40%}</center>

<br>

Õpikuid ja ülevaateid humanitaar- ja sotsiaalteaduste meetodite kohta aga ilmub üha enam. Springeri kirjastusel näiteks on terve sari [***Quantitative Methods in the Humanities and Social Sciences***](https://www.springer.com/series/11748?detailsPage=titles), mille alt on hetkeseisuga ilmunud juba tervelt 21 raamatut.  
...
Kasutame sel kursusel [R-i](https://www.r-project.org/) ja [RStudio](https://posit.co/download/rstudio-desktop/) viimaseid versioone (vastavalt R 4.3.2 ja RStudio 2023.12.1). 
...
Suuri keelemudeleid saab RStudios kasutada APIde kaudu ning selleks on vaja esmalt luua vastavat keelemudelit pakkuvas keskkonnas uus API võti (*API key*) ning seadistada see RStudios. Keelemudelite kasutamine APIde võib olla tasuline.  
