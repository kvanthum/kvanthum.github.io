...
Kursusel kasutame praktikumides ja kodutöödes erinevaid andmestikke (mille valik kohati küll tugevalt keeleteaduse poole kaldu). Selleks, et käsitletud analüüsietappe ja meetodeid veelgi paremini kinnistada, julgustame kursuse algusest peale rakendama õpitut kohe ka mõnel enda valitud andmestikul (vt ka ülesanne 1).    
...
Salvesta andmestik kausta `kvanthum2026/andmestikud`.  
...
Kui sul ei õnnestunud praegu ühtki sobivat andmestikku leida, siis kasuta etteantud Exceli faili (Ott Velsberg 2022, <https://avaandmed.eesti.ee/datasets/arvamuskusitlus-tehisintellekti-laiema-kasutuse-kohta-(12.202104.2022)>), salvestame selle kursuse andmestike kausta (nt `kvanthum2026/andmestikud`), impordime selle RStudiosse ning loome kiire ülevaate andmestiku tunnustest ja nende jaotumisest.
...
install.packages(setdiff(c("readxl", "esquisse"), rownames(installed.packages())))
