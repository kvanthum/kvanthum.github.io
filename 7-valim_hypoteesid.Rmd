...
```{r}
# Tegelikud väärtused, mis hõlmavad 99%, 95% ja 66% andmetest
quantile(kysimustik$kaua_opid, probs = c(0.005, 0.025, 0.17, 0.5, 0.83, 0.975, 0.995))
# Kolm, kaks ja üks standardhälvet keskmisest
c(kesk-3:1*shalve, kesk, kesk+1:3*shalve)
```
