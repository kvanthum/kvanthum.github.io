...
=======
>>>>>>> 1fc50a16818610f4724df42d202e97b61fe44781
...
```{r}
plot(konetempo~vanus, data=teke2, main="Kõnetempo teismelistel", xlim=c(0, 80), ylim=c(3,16))
>>>>>>> 1fc50a16818610f4724df42d202e97b61fe44781
abline(mudel)
```
...
- `anova(lm())` -- anova test
- `summary(aov())` -- anova test (sama mis eelmine)
- `TukeyHSD(aov())` -- Tukey test (post-hoc)
- `p.adjust()` -- p-väärtuste korrigeerimine (Bonferroni, Holm)
>>>>>>> 1fc50a16818610f4724df42d202e97b61fe44781
