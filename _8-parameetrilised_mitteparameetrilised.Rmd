...
Kasutame andmestikke `kysimustik_2022.RData` ja `kandidaadid.RData`
...
Kui ei ole normaaljaotus, võiks proovida normaliseerimist. Paremale kallutatud (ingl *skewed right*) asümmeetrilise jaotuse korral tasuks proovida logaritmimist (`log`). Kui mõõtmiste hulgas on väärtust 0, siis käsk `log1p`, mis lisab kõigile väärtustele +1. (Negatiivseid väärtuseid logaritmida ei saa, nii et kui neid on, siis enne logaritmimist tasuks reskaleerida andmed miinimumväärtuse suhtes.) 
